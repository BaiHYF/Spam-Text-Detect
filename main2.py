...
if __name__ == "__main__":
    tag, text = read_data('第四章/高阶示例/数据集/dataset.txt')

    chinese_characters, chinese_characters_count, chinese_characters_code = count_chinese_characters(text, '第四章/高阶示例/数据集/hanzi.txt')
